...
export default class Defaults {
    ...
    public static readonly API_BASE_URL = "https://rojifiapi.onrender.com/api/v1"; // "http://localhost:9009/api/v1"; //  "https://api.rojifi.com/api/v1"; // "http://localhost:9009/api/v1"; // 
