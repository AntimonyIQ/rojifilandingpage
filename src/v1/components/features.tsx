      ...
      <div className="container">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Unlock Global Potential with{" "}
            <span className="text-primary">Rojifi's</span> Comprehensive
            Financial Solutions
          </h2>
          <p className="mt-4 text-muted-foreground">
            At Rojifi, we understand the challenges businesses face in managing
            international transactions. That's why we offer a range of services
            designed to simplify your financial operations and help you grow
            globally.
          </p>
        </motion.div>
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:gap-12">
          ...
          >
            ...
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span>Transact in up to 200+ different countries</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-blue-500" />
                <span>
                  Collect and pay out to vendors and partners in their local
                  currencies
                </span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-blue-500" />
                <span>
                  Swift Payout in USD, EUR, GBP, CNY+ to suppliers and partners
                  abroad
                </span>
              </li>
              <li className="flex items-start gap-2">
          ...
          >
            ...
            <h3 className="text-xl font-bold">
              Expand Your Global Reach with Comprehensive Trading Solutions
            </h3>
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-2">
          ...
          >
            ...
            <h3 className="text-xl font-bold">
              Unlock Value with Competitive Foreign Exchange Rates
            </h3>
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-red-500" />
                <span>
                  Benefit from our highly competitive foreign exchange rates
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-red-500" />
                <span>
                  Manage your finances seamlessly with support for multiple
                  currencies
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-red-500" />
                <span>
                  Leverage favorable rates to enhance your international
                  transactions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-red-500" />
                <span>
                  Access up-to-date rates to make informed financial decisions
                </span>
              </li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-bold">
              Virtual Cards for Effortless Transactions
            </h3>
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-amber-500" />
                <span>
                  Assign cards to team members and manage expenses efficiently
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-amber-500" />
