            ...
            <div className="container">
                ...
                >
                    ...
                    <p className="mt-4 text-lg text-muted-foreground">
                        Our multi-currency wallet simplifies international payments for
                        businesses, allowing them to handle transactions in various
                                    ...
                                    <table className="w-full">
                                        ...
                                        <tbody className="divide-y divide-gray-100">
                                            {[
                                                ...
                                                {
                                                    beneficiary: "Global Solutions GmbH",
                                                    amount: "€18,180.50",
                                                    currency: "EUR",
                                                    date: "Dec 27, 2024",
                                                    status: "Completed",
                                                ...
                                                {
                                                    beneficiary: "Tech Innovators UK",
                                                    amount: "£15,450.00",
                                                    currency: "GBP",
                                                    date: "Dec 26, 2024",
                                                    status: "Completed",
                                                ...
                                                {
                                                    beneficiary: "Premier Consulting",
                                                    amount: "$25,000.00",
                                                    currency: "USD",
                                                    date: "Dec 25, 2024",
                                                    status: "Completed",
                                                ...
                                                {
                                                    beneficiary: "Digital Services SA",
                                                    amount: "€17,890.00",
                                                    currency: "EUR",
                                                    date: "Dec 24, 2024",
                                                    status: "Completed",
                                                ...
                                                {
                                                    beneficiary: "Innovation Partners",
                                                    amount: "£24,320.00",
                                                    currency: "GBP",
                                                    date: "Dec 23, 2024",
                                                    status: "Completed",
                                                ...
                                                >
                                                    ...
                                                    <td className="py-4 text-right">
                                                        <span
                                                            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${tx.status === "Completed"
                ...
                <div
                    className="mt-16 grid gap-8 md:grid-cols-[1fr,1fr] lg:gap-12"
                    id="features"
                >
                    <motion.div
                    ...
                    >
                        <div className="rounded-xl border bg-white p-6 shadow-sm">
                            ...
                            <p className="mt-2 text-muted-foreground">
                                Create multiple wallets and fund them in your local currency.
                                Hold NGN, USD, EUR, GBP and ZAR for limitless business
                                transactions.
                            </p>
                        </div>
                        ...
                        <div className="rounded-xl border bg-white p-6 shadow-sm">
                            ...
                            <h3 className="text-xl font-bold">
                                Seamless Currencies Conversion
                            </h3>
                            <p className="mt-2 text-muted-foreground">
                                Effortlessly swap currencies and receive instant deposits to
                                your wallet. View the latest rates to ensure you get the best
                        ...
                        <div className="rounded-xl border bg-white p-6 shadow-sm">
                            ...
                            <p className="mt-2 text-muted-foreground">
                                Send and receive money directly to local and international bank
                                accounts. Enjoy competitive rates for transactions to and from
                                Nigeria, Ghana, Asia, the US, the UK, and Europe.
                            </p>
                        </div>
                    </motion.div>
                </div>
