                    ...
                    >
                        ...
                        <div>
                            <p className="mt-6 text-lg text-muted-foreground flex items-start gap-2">
                                ...
                                <span>
                                    Seamlessly grow your global presence by making secure,
                                    efficient cross-border payments with ease.
                                    {/* <br /> Receive global payment directly to your wallet
                  <br /> Access deep liquidity in emerging markets */}
                                </span>
                            </p>
                            <p className="text-lg text-muted-foreground flex items-start gap-2">
                                ...
                                <span>Receive global payment directly to your wallet</span>
                            </p>
                            <p className="text-lg text-muted-foreground flex items-start gap-2">
                                <svg
                                    width="24"
                                ...
                                <span>Access deep liquidity in emerging markets</span>
                            </p>
                        </div>
                    ...
                    >
                      ...
                      {currencies[currentCurrency].change}
                                    ...
                                    <p className="text-xs text-gray-400 mt-1">
                                        {currencies[currentCurrency].code} Wallet
                                    </p>
                                </motion.div>
                            </AnimatePresence>
                            ...
                            <div
                                ...
                                role="group"
                                aria-label="Currency status indicators"
                            >
                                {currencies.map((curr, idx) => (
                                    <div
                                        ...
                                        aria-label={
                                            idx === currentCurrency
                                                ? `${curr.code} currency, ${idx + 1} of ${currencies.length
                                                }, currently displayed`
                                                : undefined
                                        }
                                    />
                            ...
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <div className="flex gap-1">
                                    {recentTransactions.map((_, idx) => (
                                        <div
                                            key={idx}
                                            className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${idx === currentTransaction
                                                ? "bg-primary w-4"
                                                : "bg-gray-300"
                                                }`}
                                        />
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-medium">
                                                    {recentTransactions[currentTransaction].type}
                                                </p>
                                                <p className="text-xs text-gray-500">
                                                    {recentTransactions[currentTransaction].time}
                                                </p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-sm font-bold">
                                                {recentTransactions[currentTransaction].amount}
                                            </p>
                                            <div className="flex items-center gap-1 mt-1">
                                                <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                                                <p className="text-xs text-gray-500 capitalize">
                                                    {recentTransactions[currentTransaction].status}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
