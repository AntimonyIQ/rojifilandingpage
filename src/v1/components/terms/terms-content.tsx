...
export function TermsContent() {
    ...
    return (
        <section className="relative">
            ...
            <div className="hidden md:block md:fixed md:top-10 md:left-0 md:w-1/4 md:h-full md:overflow-y-auto bg-gray-100 p-6 md:p-8 lg:p-12 -z-[1]">
            ...
            <div className="block md:hidden bg-gray-100 p-6">
                <h1 className="text-3xl font-bold mb-2">{TERMS_CONFIG.title}</h1>
                <p className="text-sm text-gray-500">Last updated: {TERMS_CONFIG.lastUpdated}</p>
            </div>
