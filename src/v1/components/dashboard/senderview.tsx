                                ...
                                {sortedCountries
                                    ...
                                    .map((c) => (
                                        <button
                                            ...
                                            className={`flex items-center justify-between w-full gap-3 p-3 rounded-md border ${selectedCountry === c.iso2
                                ...
                                {businessLoading ? (
                                    ...
                                    <div className="space-y-2">
                                        {businessOptions.map((biz) => (
                                            <div
                                                key={biz.id}
                                                className={`flex items-center justify-between border rounded-md px-4 py-3 cursor-pointer transition-colors ${selectedBusiness === biz.id
                                            ...
                                            >
                                                <span
                                                    className={`mr-3 flex items-center justify-center w-6 h-6 rounded-full ${selectedBusiness === biz.id
                                                        ? "bg-green-500"
                                                        : "bg-gray-300"
                                                        }`}
                                                >
