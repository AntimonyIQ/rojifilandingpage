                                            ...
                                            beneficiaries.map((beneficiary) => (
                                                ...
                                                >
                                                    ...
                                                    <td
                                                        ...
                                                        title={beneficiary.beneficiaryAccountNumber || beneficiary.beneficiaryIban}
                                                    >
                                                        {beneficiary.beneficiaryAccountNumber || beneficiary.beneficiaryIban}
                                                    </td>
                                                    <td
                                                        className="py-4 px-6 text-sm text-gray-600 whitespace-nowrap max-w-xs truncate"
                    ...
                    <DialogContent className="max-w-4xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="text-lg font-medium text-gray-900 p-3 bg-gray-50 rounded-lg">
                                    {selectedTransaction?.beneficiaryAccountNumber || selectedTransaction?.beneficiaryIban || "N/A"}
                                </div>
                            </div>
                            <div className="space-y-2">
                                <div className="text-sm text-gray-500 font-medium uppercase tracking-wide">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="text-lg font-medium text-green-600 p-3 bg-green-50 rounded-lg">
                                    {getCurrencySymbol(selectedTransaction?.beneficiaryCurrency || '')}
                                    {Number(
