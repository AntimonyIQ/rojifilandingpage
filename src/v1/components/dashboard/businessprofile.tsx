...
export function BusinessProfileView() {
    ...
    useEffect(() => {
        if (storage) {
            ...
            setKycCompleted(storage.sender.businessVerificationCompleted);
            setLoading(false);
        }
    }, [storage]);
    ...
    const directorHasIssue = (directors || []).some(
        (d: IDirectorAndShareholder) => {
    ...
    const directorInReview: boolean = (directors || []).some(
                ...
                >
                    <div className="flex gap-1 p-1 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200">
                        {(hasFailed || directorHasIssue
                            ? statusTabs
                            : statusTabs.filter(
                                (tab) => tab === Tabs.KYC || tab === Tabs.OVERVIEW
                            )
                        ).map((status) => (
                            <button
                                key={status}
                            ...
                            <CardContent className="p-8">
                                ...
                                <div className="grid md:grid-cols-2 gap-8 mb-8">
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-gray-600 mb-4">
                                            Upload required business registration and incorporation
                                            documents, business address with recent utility bill or
                                            bank statement
                                        </p>
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-gray-600 mb-4">
                                            Add and manage all company directors and shareholders
                                            information, address with recent utility bill or bank
                                            statement
                                        </p>
                                ...
                                {!allVerified && (
                                    <div className="text-center">
                                        <div
                                            className={`inline-flex items-center gap-2 px-4 py-2 rounded-full ${hasFailed
                        ...
                        <Card className="w-full max-w-2xl border-0 bg-white/95 backdrop-blur-sm">
                            <CardContent className="p-8 text-center">
                                ...
                                <p className="text-gray-600 mb-8">
                                    Congratulations! Your business KYC verification has been
                                        ...
                                        <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border">
                                            <p className="font-semibold text-gray-900">
                                                {companyActivityOptions.find(
                                                    (opt) => opt.value === sender?.companyActivity?.[0]
                                                )
                                                    ? `${companyActivityOptions.find(
                                                        (opt) =>
                                                            opt.value === sender?.companyActivity?.[0]
                                                    )?.label
                                                    }`
                                                    : "Not Provided"}
                                            </p>
              ...
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Requested services and funding sources
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border">
                      <div className="flex flex-wrap gap-2">
                        {sender?.sourceOfWealth &&
                        sender.sourceOfWealth.length > 0 ? (
                    ...
                    <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border">
                      <div className="flex flex-wrap gap-2">
                        ...
                        sender.anticipatedSourceOfFundsOnDunamis.length > 0 ? (
                          sender.anticipatedSourceOfFundsOnDunamis.map(
                            (source, index) => (
                              <Badge
                                key={index}
                                variant="outline"
                ...
                {/* <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge variant="secondary" className="px-3 py-1">
                      {directors.length}{" "}
                      {directors.length === 1 ? "Person" : "People"}
                    </Badge>
                  </div>
                </div> */}
                    ...
                    <div className="mb-6">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${
                              ((currentDirectorIndex + 1) / directors.length) *
                              100
                            }%`,
                          }}
                        />
                            ...
                            <p className="font-semibold text-gray-900">
                              {`${directors[currentDirectorIndex]?.firstName} ${
                                directors[currentDirectorIndex]?.middleName
                                  ? directors[currentDirectorIndex]
                                      ?.middleName + " "
                                  : ""
                              }${directors[currentDirectorIndex]?.lastName}`}
                            </p>
                            ...
                            <div className="p-4 rounded-lg border">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-gray-600">
                                  {directors[currentDirectorIndex]?.idType ===
                                  "passport"
                                    ? "Passport"
                                    : "Driver's License"}
                                </span>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setCurrentDirectorIndex(
                            Math.max(0, currentDirectorIndex - 1)
                          )
                        }
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-6">
                      Add directors and shareholders to complete your business
                      profile.
                    </p>
