...
const companyActivityOptions = [...industryOptions];
...
export function BusinessDetailsForm() {
    ...
    const [countriesOfOperationPopover, setCountriesOfOperationPopover] =
        useState(false);
    const [customerBaseBreakdownPopover, setCustomerBaseBreakdownPopover] =
        useState(false);
    ...
    const [_businessDetails, setBusinessDetails] =
        useState<ISmileIdBusinessResponse | null>(null);
    ...
    const isValidWebsite = (website: string) => {
        ...
        // Allow www. prefix
        const withWwwPattern =
            /^www\.[a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?(\.[a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?)*\.[a-zA-Z]{2,}(\/.*)?$/;

        return (
            domainPattern.test(cleanWebsite) || withWwwPattern.test(cleanWebsite)
        );
    };
            ...
            if (data.status === Status.SUCCESS) {
                ...
                setFormData((prev) => ({
                    ...
                    actualOperationsAndRegisteredAddressesMatch:
                        parseData.sender.actualOperationsAndRegisteredAddressesMatch ??
                        true,
                    actualOperationsAddress: {
                        streetAddress:
                            parseData.sender.actualOperationsAddress?.streetAddress || "",
                        streetAddress2:
                            parseData.sender.actualOperationsAddress?.streetAddress2 || "",
                        ...
                        postalCode:
                            parseData.sender.actualOperationsAddress?.postalCode || "",
    ...
    const handleCountriesOfOperationChange = (countryName: string) => {
        setFormData((prev) => {
            ...
            if (isSelected) {
                ...
                return {
                    ...prev,
                    countriesOfOperation: currentCountries.filter(
                        (c) => c !== countryName
                    ),
                };
            } else {
                    ...
                    actualOperationsAddress:
                        formData.actualOperationsAndRegisteredAddressesMatch
                            ...
                            : {
                                ...
                                streetAddress2:
                                    formData.actualOperationsAddress.streetAddress2,
    ...
    const fetchBusinessDetails = async (businessRegNum: string) => {
        try {
            ...
            if (data.status === Status.SUCCESS) {
                ...
                const parseData: ISmileIdBusinessResponse = Defaults.PARSE_DATA(
                    data.data,
                    storage.client.privateKey,
                    data.handshake
                );
                ...
                setFormData((prev) => ({
                    ...
                    registrationNumber: businessRegNum,
                    registrationDate: parseData.company_information?.registration_date
                        ? new Date(parseData.company_information.registration_date)
                        : prev.registrationDate,
                    // leave empty if tax_id: "Not Available"
                    taxId:
                        parseData.company_information?.tax_id &&
                            parseData.company_information.tax_id !== "Not Available"
                            ? parseData.company_information.tax_id
                            : prev.taxId,
                }));
            }
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    />
                                    <div
                                        className={`items-center gap-2 text-gray-500 text-xs mt-1 ${businessLoading ? "flex" : "hidden"
                                            }`}
                                    >
                                ...
                                <div>
                                    ...
                                    />
                                    <div
                                        className={`items-center gap-2 text-gray-500 text-xs mt-1 ${taxLoading ? "flex" : "hidden"
                                            }`}
                                    >
                                        <Loader size={16} className={cn("animate-spin")} />
                                        Validating...
                                ...
                                <div>
                                    ...
                                    <Popover
                                        ...
                                        onOpenChange={setLegalFormPopover}
                                    >
                                ...
                                <div>
                                    ...
                                    <Popover
                                        open={businessActivityPopover}
                                        onOpenChange={setBusinessActivityPopover}
                                    >
                                        <PopoverTrigger asChild>
                                            <Button
                                                variant="outline"
                                            ...
                                            >
                                                {formData.businessIndustryType
                                                    ? BusinessActivitiesOptions.find(
                                                        (activity) =>
                                                            activity.value === formData.businessIndustryType
                                                    )?.label
                                ...
                                <div>
                                    ...
                                    <Popover
                                        ...
                                        onOpenChange={setActivityPopover}
                                    >
                                        <PopoverTrigger asChild>
                                            <Button
                                                variant="outline"
                                                    ...
                                                    {formData.companyActivity.length === 0
                                                        ...
                                                        : formData.companyActivity.length === 1
                                                            ? companyActivityOptions.find(
                                                                (activity) =>
                                                                    activity.value === formData.companyActivity[0]
                                                            )?.label
                                                        ...
                                                        {companyActivityOptions.map((activity) => (
                                                            ...
                                                            >
                                                                <CheckIcon
                                                                    className={cn(
                                                                        "mr-2 h-4 w-4",
                                                                        formData.companyActivity.includes(
                                                                            activity.value
                                                                        )
                                                                            ? "opacity-100"
                                                                            : "opacity-0"
                                            ...
                                            {formData.companyActivity.map((activityValue) => (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={() =>
                                                            handleCompanyActivityChange(activityValue)
                                                        }
                                ...
                                <div>
                                    <Label
                                        ...
                                        className="block text-sm font-medium text-gray-700 mb-2"
                                    >
                                        Please describe your business model in details{" "}
                                        <span className="text-red-500">*</span>
                                    </Label>
                                    <textarea
                                        id="businessModel"
                                ...
                                <div>
                                    ...
                                    <Popover
                                        open={customerBaseBreakdownPopover}
                                        onOpenChange={setCustomerBaseBreakdownPopover}
                                    >
                                        <PopoverTrigger asChild>
                                            <Button
                                                variant="outline"
                                            ...
                                            >
                                                {formData.customerBaseBreakdown
                                                    ? customerBaseBreakdownOptions.find(
                                                        (option) =>
                                                            option.value === formData.customerBaseBreakdown
                                                    )?.label
                                                    ...
                                                    <CommandGroup>
                                                        {countries.map((country, index) => (
                                                            <CommandItem
                                                                ...
                                                                value={country.name}
                                                                onSelect={() => {
                                                                    handleCountriesOfOperationChange(
                                                                        country.name
                                                                    );
                                                                }}
                                                            >
                                                                <CheckIcon
                                                                    className={cn(
                                                                        "mr-2 h-4 w-4",
                                                                        formData.countriesOfOperation.includes(
                                                                            country.name
                                                                        )
                                                                            ? "opacity-100"
                                                                            : "opacity-0"
                                            ...
                                            {formData.countriesOfOperation.map((countryName) => (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={() =>
                                                            handleCountriesOfOperationChange(countryName)
                                                        }
                                                        className="ml-1 text-blue-600 hover:text-blue-800"
                                                    >
                                                        ×
                            ...
                            <div className="pt-2 px-0 md:px-0 max-w-md mx-auto">
                                <label className="flex items-center space-x-3 text-sm text-gray-700">
                                    ...
                                    />
                                    <span>
                                        Actual operations address matches registered address
                                    </span>
                                </label>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            <Popover
                                                ...
                                                onOpenChange={() =>
                                                    setActualCountryPopover(!actualCountryPopover)
                                                }
                                            >
                                                <PopoverTrigger asChild>
                                                    <Button
