...
export function DirectorShareholderFormComponent({
    sender,
}: {
        sender: ISender;
}) {
    ...
    useEffect(() => {
        const existingDirectors: Array<IDirectorAndShareholder> =
            (sender.directors || []) as Array<IDirectorAndShareholder>;
        ...
        // console.log("Directors", sender.directors);
        ...
        const mapped = existingDirectors.map((d) => ({
            ...
            shareholderPercentage:
                d.shareholderPercentage !== undefined &&
                    d.shareholderPercentage !== null
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <DialogDescription className="text-sm text-gray-600">
                                ...
                                (
                                {(file instanceof File ? file.size : file?.size || 0) /
                                    1024 /
                                    1024}{" "}
                                MB)
                            </DialogDescription>
            ...
            <FileViewerModal
                file={
                    file
                        ? file
                        : fileUrl
                            ? { url: fileUrl, type: "application/octet-stream" }
                            : null
                }
                isOpen={showViewer}
